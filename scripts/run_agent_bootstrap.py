...
def main():
    ...
    archive = run(["git", "archive", "--format=tar", args.revision,
                   "scripts/bootstrap_agent.py", "host/agent", "host/k3s/config.yaml", "config/agent-views.sql", "config/agent-open-platform-views.sql", "config/agent-wecom-kf-views.sql", "config/agent-media-policy.json"], binary=True)
